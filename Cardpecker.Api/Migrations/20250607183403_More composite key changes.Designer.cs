...
namespace Cardpecker.Api.Migrations
{
    ...
    [Migration("20250607183403_More composite key changes")]
    partial class Morecompositekeychanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cardpecker.Api.MagicCardPricingPoint", b =>
                {
                    ...
                    b.HasKey("ScryfallId", "PricingProvider", "PrintingVersion", "IsMagicOnline");
