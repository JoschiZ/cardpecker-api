...
using MtgJson.Importer.Entities;

namespace MtgJson.Importer.Context;

internal partial class MtgJsonContext : DbContext
{
    public MtgJsonContext(DbContextOptions<MtgJsonContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Card>(entity =>
        {
            ...
            entity.Property(e => e.IsGameChanger)
                .HasColumnType("BOOLEAN")
                .HasColumnName("isGameChanger");
        ...
        modelBuilder.Entity<CardForeignDatum>(entity =>
        {
            ...
            entity.Property(e => e.FaceName).HasColumnName("faceName");
            entity.Property(e => e.FlavorText).HasColumnName("flavorText");
            entity.Property(e => e.Identifiers).HasColumnName("identifiers");
            entity.Property(e => e.Language).HasColumnName("language");
        ...
        modelBuilder.Entity<CardIdentifier>(entity =>
        {
            ...
            entity.Property(e => e.CardsphereFoilId).HasColumnName("cardsphereFoilId");
            entity.Property(e => e.CardsphereId).HasColumnName("cardsphereId");
            entity.Property(e => e.DeckboxId).HasColumnName("deckboxId");
            ...
            entity.Property(e => e.MultiverseId).HasColumnName("multiverseId");
            entity.Property(e => e.ScryfallCardBackId).HasColumnName("scryfallCardBackId");
        ...
        modelBuilder.Entity<CardLegality>(entity =>
        {
            ...
            entity.Property(e => e.Standardbrawl).HasColumnName("standardbrawl");
            entity.Property(e => e.Timeless).HasColumnName("timeless");
            entity.Property(e => e.Uuid).HasColumnName("uuid");
        ...
        modelBuilder.Entity<Set>(entity =>
        {
            ...
            entity.HasIndex(e => e.Code, "IX_sets_code").IsUnique();
